...
//                FACTS.GenericBooking.Repository.Postgres.FactsDbContext.Logger.Log(LogLevel.Error, exception, $"{nameof(SaveChanges)} validation exception: {exception.Message}; members:{members} inner exp {exception.InnerException}");
//                RejectChanges();
//                throw;
//            }
...
//                FACTS.GenericBooking.Repository.Postgres.FactsDbContext.Logger.Log(LogLevel.Error, exception, $"{nameof(SaveChanges)} db update error table {schema}.{table} details: {detail} innerExp: {exception.InnerException}");
//                RejectChanges();
//                throw;
//            }
//            catch (Exception exception)
//            {
//                FACTS.GenericBooking.Repository.Postgres.FactsDbContext.Logger.Log(LogLevel.Error, exception, $"{nameof(SaveChanges)} db exception: {exception.InnerException}");
//                RejectChanges();
//                throw;
//            }
//        }
